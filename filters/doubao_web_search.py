"""
title: Doubao Web Search
author: OVINC CN
git_url: https://github.com/OVINC-CN/OpenWebUIPlugin.git
description: Doubao Web Search
version: 0.0.1
licence: MIT
"""
...
class Filter:
    class Valves(BaseModel):
        limit: int = Field(default=10, title="最大结果条数")
    ...
    def inlet(self, body: dict) -> dict:
        tool: Dict[str, Union[str, int]] = {"type": "web_search", "limit": self.valves.limit}
        if body.get("tools"):
