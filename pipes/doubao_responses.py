...
class Pipe:
    class Valves(BaseModel):
        base_url: str = Field(default="ark.cn-beijing.volces.com/api/v3", title="Base URL")
        ...
        models: str = Field(default="doubao-seed-2-0-lite-260215", title="模型", description="使用英文逗号分隔多个模型")

    class UserValves(BaseModel):
        reasoning_effort: Literal["minimal", "low", "medium", "high"] = Field(default="medium", title="思考推理强度")
        thinking: bool = Field(default=True, title="深度思考模式")
